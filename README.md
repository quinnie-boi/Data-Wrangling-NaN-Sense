...
In the end, your folder structure should look something like:
```
Data
├── cleaned 
│	 # each of these is generated by our scripts
│   ├── chch_airbnb_listings.csv
│   ├── chch_airbnb_listings_with_sa2.csv
│   ├── merged_listings_and_bonds.csv
│   └── tenancy_bonds.csv
├── uncleaned_airbnb_listings
│   # You downloaded these in week 5
│   ├── listings-25-10.csv
│   ├── listings-25-11.csv
│   ├── listings-25-12.csv
│   ├── listings-26-01.csv
...
│   ├── listings-26-05.csv
│   └── listings-26-06.csv
│   # This is the merged airbnb listings
├── uncleaned_airbnb_listings.csv 
└── uncleaned_bonds.csv (You download this)
```
